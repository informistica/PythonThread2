...
if __name__ == "__main__":
    ...
    task1 = multiprocessing.Process(target=task, args=("1.Prepara il condimento",))
    task2 = multiprocessing.Process(target=task, args=("2.Fai bollire acqua",))
    task3 = multiprocessing.Process(target=task, args=("3.Metti a cuocere la pasta",))
    task4 = multiprocessing.Process(target=task, args=("4.Consumare la pasta",))
    task1.start() 
    task2.start() 
    task1.join()
    task2.join()
